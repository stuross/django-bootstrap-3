...
def is_checkbox(field):
    return field.widget.__class__.__name__.lower() == "checkboxinput"

def is_multiple_checkbox(field):
    return field.widget.__class__.__name__.lower() == "checkboxselectmultiple"

def is_radio(field):
    return field.widget.__class__.__name__.lower() == "radioselect"
...
class BootstrapMixin(object):
    ...
    def render_field(self, field):
        ...
        if not is_checkbox(field_instance) and not is_multiple_checkbox(field_instance) and not is_radio(field_instance):
            if hasattr(field_instance.widget, 'widgets'):
                for sub_widget in field_instance.widget.widgets:
                    sub_widget.attrs['class'] = sub_widget.attrs.get('class',' ') + ' form-control'
            else:
                field_instance.widget.attrs['class'] = field_instance.widget.attrs.get('class',' ') + ' form-control'
